...
export default function PlansPage() {
  ...
  function renderPlanCard(plan: Plan) {
    ...
    const pStatus = getPlanStatus(plan);
    ...
    return (
      <div key={plan.id} style={{ marginBottom: 16 }}>
        ...
        <div style={{ ...cardStyle, marginBottom: 0 }}>
            ...
            <div className="da-plan-header" style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16, flexWrap: "wrap", marginBottom: 12 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }} onClick={(e) => e.stopPropagation()}>
                {editingPlanId === plan.id ? (
                  ...
                  <>
                    <button onClick={() => openEditPlan(plan)} style={btnOutline}>
                      Edit Plan
                    </button>
                    <button
          ...
          {/* CARD BODY — edit form or view content */}
          {editingPlanId === plan.id ? (
            <div style={{ borderTop: "2px solid var(--color-green)", paddingTop: 20, marginTop: 12 }}>
              <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                <div>
                  <label style={labelStyle}>Plan Name</label>
                  <input
            ...
            <>
              ...
              >
                ...
                <p style={{ fontSize: 13, color: "#292524", fontFamily: "var(--font-mono)", margin: "0 0 16px 0" }}>
                  ...
                  {pStatus === "active" && <> &middot; {progress.daysRemaining} day{progress.daysRemaining !== 1 ? "s" : ""} remaining</>}
                </p>

                {/* 3. Progress bar */}
                <div style={{ marginBottom: plan.notes ? 16 : 0 }}>
                    ...
                    return (
                      ...
                      >
                        ...
                        {goal.original_description && (
                          <div style={{ background: "#FFFBEB", border: "1px solid #FDE68A", borderRadius: 8, padding: "12px 14px", marginBottom: 8, marginTop: 8 }}>
                            ...
                            <div style={{ fontSize: 13, color: "#292524", fontFamily: "var(--font-sans)", lineHeight: 1.5, textDecoration: "line-through", marginBottom: 6 }}>
                              {renderMarkdown(goal.original_description!)}
                            </div>
                            <div style={{ fontSize: 13, color: "#292524", fontFamily: "var(--font-sans)", lineHeight: 1.5, marginBottom: 0 }}>
                              {renderMarkdown(goal.description || "")}
                            </div>
                            {goal.revision_notes && (
                              <div style={{ fontSize: 12, color: "#92400E", fontFamily: "var(--font-sans)", lineHeight: 1.5, marginTop: 6, fontStyle: "italic" }}>
                                Note: {renderMarkdown(goal.revision_notes)}
                              </div>
                            )}
                          </div>
                        )}
                    ...
                    <div key={`${rev.goalId}-${idx}`} style={{ position: "relative", marginBottom: 20 }}>
                      ...
                      <div style={{ background: "#FFFBEB", border: "1px solid #FDE68A", borderRadius: 10, padding: "16px 18px" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
                          <span style={{ fontSize: 12, fontFamily: "var(--font-mono)", fontWeight: 700, color: "#92400E" }}>
                            {formatDate(rev.date)}
                          </span>
                        ...
                        <div style={{ marginBottom: 6 }}>
                          ...
                          <div style={{ fontSize: 13, color: "#292524", fontFamily: "var(--font-sans)", lineHeight: 1.5, marginTop: 2, textDecoration: "line-through" }}>
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: 13, color: "#292524", fontFamily: "var(--font-sans)", lineHeight: 1.5, marginTop: 2 }}>
                            {renderMarkdown(rev.revised)}
                          </div>
                        </div>
                        {rev.notes && (
                          <div style={{ fontSize: 12, color: "#92400E", fontStyle: "italic", fontFamily: "var(--font-sans)", lineHeight: 1.5, marginTop: 6 }}>
